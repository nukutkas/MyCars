...
class ViewController: UIViewController {
    ...
    @IBAction func rateItPressed(_ sender: UIButton) {
        let alerController = UIAlertController(title: "Rate it", message: "Rate this car please", preferredStyle: .alert)
        let rateAction = UIAlertAction(title: "Rate", style: .default) { action in
            if let text = alerController.textFields?.first?.text {
        ...
        alerController.addAction(rateAction)
    ...
    private func update(rating: Double) {
        ...
        do {
            ...
            let alertController = UIAlertController(title: "Wrong value", message: "Wront input", preferredStyle: .alert)
